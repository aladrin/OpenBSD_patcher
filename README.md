# An automated way to fetch and compile security patches to OpenBSD. Suitable for embedded devices, this solution uses a staged ramdisk mounted from a NFS server.
